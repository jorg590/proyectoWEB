...
- 2.1 plan de comunicacion
  Tabla 1. descripcion de componentes y elemetnos de comunicacion
  | medio de comunicacion | frecuencia | interesados |
  | :--- | :---: | ---: |
  | whatsapp | diario | equipo de trabajo |
  | meet | semanal | equipo de trabajo-cliente |
  | jira | por hora | equipos de trabajo-director de proyecto |
- 2.2 plan de *tiempo*
- 2.3 plan de *costos*
